...
vim.api.nvim_create_autocmd('FileType', {
  pattern = { 'gitcommit', 'lazy', 'help', 'man' },
  callback = function()
...
vim.keymap.set("v", "<Plug>(my-move-range)", "<Nop>", { silent = true })
vim.keymap.set("v", "<C-j>", ":m '>+1<CR>gv=gv<Plug>(my-move-range)", { silent = true, remap = true })
vim.keymap.set("v", "<C-k>", ":m '<-2<CR>gv=gv<Plug>(my-move-range)", { silent = true, remap = true })
vim.keymap.set("v", "<Plug>(my-move-range)<C-k>", "<Cmd>undojoin | '<,'>m '<-2<CR>gv=gv<Plug>(move-range)",
  { silent = true })
vim.keymap.set("v", "<Plug>(my-move-range)<C-j>", "<Cmd>undojoin | '<,'>m '>+1<CR>gv=gv<Plug>(move-range)",
  { silent = true })
